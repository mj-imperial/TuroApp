...
sealed class Screen(val route: String) {
    ...
    object StudentQuizDetail: Screen("quiz_detail/{courseId}/{quizId}/{type}"){
        fun createRoute(courseId: String, quizId: String, type: String?) = "quiz_detail/$courseId/$quizId/${type}"
    }
